...
SYNOPTIQUE_VARIABLES = {
    ...
    "px_current_pdc1": "ns=1;s=R1:Px_MXR[1].ORI.IDCMeas",
    "px_current_pdc2": "ns=1;s=R1:Px_MXR[2].ORI.IDCMeas",
    "px_current_pdc3": "ns=1;s=R1:Px_MXR[3].ORI.IDCMeas",
    "px_current_pdc4": "ns=1;s=R1:Px_MXR[4].ORI.IDCMeas",

    "px_voltage_pdc1": "ns=1;s=R1:Px_MXR[1].ORI.VDCMeas",
    "px_voltage_pdc2": "ns=1;s=R1:Px_MXR[2].ORI.VDCMeas",
    "px_voltage_pdc3": "ns=1;s=R1:Px_MXR[3].ORI.VDCMeas",
    "px_voltage_pdc4": "ns=1;s=R1:Px_MXR[4].ORI.VDCMeas",

    "evi_voltage_pdc1": "ns=1;s=R1:EVI_P1.OLI.EVSE_MeasVDC",
    "evi_voltage_pdc2": "ns=1;s=R1:EVI_P2.OLI.EVSE_MeasVDC",
    "evi_voltage_pdc3": "ns=1;s=R1:EVI_P3.OLI.EVSE_MeasVDC",
    "evi_voltage_pdc4": "ns=1;s=R1:EVI_P4.OLI.EVSE_MeasVDC",

    "dcbm_voltage_pdc1": "ns=1;s=R1:DCBM1.LiveMesure.Voltage",
    "dcbm_voltage_pdc2": "ns=1;s=R1:DCBM2.LiveMesure.Voltage",
    "dcbm_voltage_pdc3": "ns=1;s=R1:DCBM3.LiveMesure.Voltage",
    "dcbm_voltage_pdc4": "ns=1;s=R1:DCBM4.LiveMesure.Voltage",

    "px_power_pdc1": "ns=1;s=R1:Px_MXR[1].ORI.PDCMeas",
    "px_power_pdc2": "ns=1;s=R1:Px_MXR[2].ORI.PDCMeas",
    "px_power_pdc3": "ns=1;s=R1:Px_MXR[3].ORI.PDCMeas",
    "px_power_pdc4": "ns=1;s=R1:Px_MXR[4].ORI.PDCMeas",

    "nb_mxr_available_pdc1": "ns=1;s=R1:Px_MXR[1].OLI.Nb_Avail",
    "nb_mxr_available_pdc2": "ns=1;s=R1:Px_MXR[2].OLI.Nb_Avail",
    "nb_mxr_available_pdc3": "ns=1;s=R1:Px_MXR[3].OLI.Nb_Avail",
    "nb_mxr_available_pdc4": "ns=1;s=R1:Px_MXR[4].OLI.Nb_Avail",

    "nb_mxr_running_pdc1": "ns=1;s=R1:Px_MXR[1].OLI.Nb_Running",
    "nb_mxr_running_pdc2": "ns=1;s=R1:Px_MXR[2].OLI.Nb_Running",
    "nb_mxr_running_pdc3": "ns=1;s=R1:Px_MXR[3].OLI.Nb_Running",
    "nb_mxr_running_pdc4": "ns=1;s=R1:Px_MXR[4].OLI.Nb_Running",
}
