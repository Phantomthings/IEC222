...
IC_MAP = {
    1: "IC01 - EV Px Contactor closed",
    6: "IC06 - OCPPEndPoint communication fault",
    7: "IC07 - HMI communication fault",
    8: "IC08 - HMI Step not in idle view",
    9: "IC09 - DCBM communication fault",
    10: "IC10 - Number of modules available  Px < 1",
    11: "IC11 - Tilt sensor fault",
}

PC_MAP = {
    0: "PC00 - RIO  communication failure",
    2: "PC02 - Px MXR Number module running < 0",
    3: "PC03 - Tilt sensor fault",
    4: "PC04 - Px contactor mismatch",
    5: "PC05 - Charge box surge protector fault",
    6: "PC06 - Px Column surge protector fault",
    7: "PC07 - Time out SEQx",
    8: "PC08 - EVI default temperature",
    9: "PC09 - VDC measurement Px - OverVoltage",
    11: "PC11 - Firefighter emergency stop",
    12: "PC12 - EVI Com OK",
    13: "PC13 - ES EVI",
    14: "PC14 - Manual Indispo",
    15: "PC15 - Px module fault",
}
